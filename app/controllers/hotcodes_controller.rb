class HotcodesController < ApplicationController
  ...
  private
    ...
    def hotcode_params
      params.require(:hotcode).permit(:standard_hot, :hot7, :manufacturer_code, :preparation_code, :logistics_code, :jan, :mhlw, :yj, :receden_code1, :receden_code2, :notice, :product_name, :receden_name, :unit, :package_style, :package_unit_num, :package_unit_unit, :total_package_unit_num, :total_package_unit_unit, :category, :manufacturer, :seller, :update_category, :update_date)
    end
end
